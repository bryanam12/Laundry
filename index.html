...
<html lang="en">
    <head>
        ...
        <title>AAA Laundry Landing Page</title>
        <!-- Favicon-->
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Laundry &middot; Cepat &middot; Berkualitas</div></div>
                                <div class="fs-3 fw-light text-muted">Laundry murah hanya di AAA Laundry</div>
                                <h5 class="display-4 fw-bolder mb-5"><span class="text-gradient d-inline">1 kg cucian hanya Rp.5000!!</span></h5>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="Pesan_Cucian.php">Pesan Cucian sekarang!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    <img class="profile-img w-100 h-auto mb-5" src="AAA Laundry.png" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
